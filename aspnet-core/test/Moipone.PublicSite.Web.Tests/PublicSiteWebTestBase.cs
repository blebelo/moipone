...
public abstract class PublicSiteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PublicSiteWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PublicSiteWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PublicSiteDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PublicSiteDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PublicSiteDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PublicSiteDbContext, Task<T>> func)
    {
        T result;
