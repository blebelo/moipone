...
namespace Moipone.PublicSite.Migrations
{
    ...
    [Migration("20260918114415_Refactored_Attendance_Relationships")]
    partial class Refactored_Attendance_Relationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moipone.PublicSite.Domain.Contacts.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Moipone.PublicSite.Domain.Visitors.Visitor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Moipone.PublicSite.Domain.Visits.AttendanceRegister", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Moipone.PublicSite.Domain.Visits.Visit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Moipone.PublicSite.Domain.Visitors.Visitor", b =>
                {
                    b.HasOne("Moipone.PublicSite.Domain.Addresses.Address", "VisitorAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Moipone.PublicSite.Domain.Visits.Visit", b =>
                {
                    b.HasOne("Moipone.PublicSite.Domain.Visits.AttendanceRegister", null)
                        .WithMany("Visits")
                        .HasForeignKey("AttendanceRegisterId");

                    b.HasOne("Moipone.PublicSite.Domain.Visitors.Visitor", "Visitor")
                        .WithMany("Vists")
