...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = PublicSiteConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(PublicSiteDbContext context)
    {
        _context = context;
    }
